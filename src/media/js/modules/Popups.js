...
const DEBUG = true; // TEMP

// TODO: Обсудить с ребятами, можно ли использовать данный модуль
// (взят с моего личного стартера, которым пользовался на предыдущем месте работы).
// Если ок, то отрефакторить, привести к нормальному виду.
function Popups() {
	/**
	 * Всплывашки на сайте
	 *
